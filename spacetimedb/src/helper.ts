...
// export const generateShortId = customAlphabet(alphabet, 12); // Default length of 12
// A 12-character NanoID using the default alphabet provides 4,722,366,482,869,645,213,696 (approx. 4.72 sextillion) unique combinations. 
// export const generateShortId = createId;
